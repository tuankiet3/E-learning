...
namespace E_learning.Repositories
{
    public class CourseRepository : ICourseRepository
    {
        ...
        public Task<bool> DeleteLessonsByCourseID(string courseID) => _lessonDAL.deleteLesson(courseID);
        // Quiz methods
        ...
        public Task<bool> DeleteChoicesByQuizID(string quizID) => _choiceDAL.DeleteChoicesByQuizID(quizID);
    }
}
